            ...
            <table class="table table-striped" v-if="tasks.length > 0">
                ...
                <tbody>
                   <tr v-for="(task, index) in tasks">
                       ...
                       <td>
                             <button @click="initUpdate(index)" class="btn btn-success btn-xs" style="padding:8px"><i class="fas fa-edit"></i></button>
                             
                             <button @click="deleteTask(index)" class="btn btn-danger btn-xs" style="padding:8px"><i class="fas fa-trash"></i></button>
                       </td>
                   </tr>
                </tbody>
            </table>
