...
<div id="toolbar" class="toolbar btn-toolbar ">
  <div class="toolbar-action">
    <router-link :to="{ name: 'create_mealtime'}">
    ...
    <b-table striped hover responsive :items="items" 
      ...
      <template v-slot:cell(actions)="row">
        <router-link :to="{ name: 'update_mealtime', params: { postId : String(row.item.id) } }">
...
<script>
    ...
    export default {
      ...
      methods: {
        ...
        deletePost(id) {
          axios.delete("/api/mealtime/" + id).then(response => this.getPosts())
        },
